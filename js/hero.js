...
const PROJECTION = {
  /** Opacity del haz primario / secundario (aditivo), centrado. */
  beamOpacity: 0.42,
  beamOpacitySecondaryRatio: 0.55,
  ...
  dustSize: 0.11,
  dustOpacity: 0.4,
  /** Escala de los haces mientras hay foco. */
  focusPunch: 1.6,
...
function buildProjection(instance) {
  ...
  /*
    Haz centrado entre cámara y stills (no en las esquinas del frame):
    así no se corta en el overflow del stage.
  */
...
function createBeamCanvas() {
  ...
  radial.addColorStop(0, "rgba(255, 248, 236, 0.75)");
  radial.addColorStop(0.35, "rgba(255, 240, 220, 0.22)");
